...
export const UserPage = () => {
    ...
    return (
        <div className={"user-page"}>
            <Paper elevation={24} sx={{ display: 'flex', flexDirection: 'column', padding: '40px', borderRadius: '20px', gap: '20px', width: '900px', opacity: 0.8, alignItems: 'center'}} >
                <img src={'/SubHUB.png'} style={{ width: '200px'}}/>

                {isUserContractOwner ? (
                    <>
                        <span className={"user-page__greeting"}>Welcome to your administrator panel!</span>
                        { subscriptionFee && (
                            <span className={'user-page__fee-info'}> Current subscription fee: { String(ethers.utils.formatEther(subscriptionFee!))} ETH </span>
                        )}
