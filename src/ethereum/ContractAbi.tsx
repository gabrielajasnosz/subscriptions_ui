...
export const contractABI = [
  {
    inputs: [
      { internalType: "uint256", name: "_subscriptionFee", type: "uint256" },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "subscriptionDue", type: "uint256" },
    ...
    outputs: [
      {
        components: [
          ...
          { internalType: "string", name: "firstName", type: "string" },
          { internalType: "string", name: "lastName", type: "string" },
          { internalType: "bool", name: "isSubscriptionActive", type: "bool" },
        ],
        internalType: "struct SubscriptionService.SubscriberInfo[]",
        name: "",
        type: "tuple[]",
      },
    ],
